// note: does not work in characteristic 2; this code uses Igusa-Clebsch invariants so it should not be used in characteristic 3 either
...
// this version uses Igusa invariants and can handle characteristic 3 as well
function HasSplitJac22(C)
    K :=  BaseField(C);
    ...
    II := [
        ...
        -4096*a^6*c^2 + 2048*a^5*b^2*c - 256*a^4*b^4 + 299008*a^4*b*c^2 -
            82944*a^3*b^3*c + 2304000*a^3*c^3 + 2048*a^2*b^5 - 1838592*a^2*b^2*c^2 +
            299008*a*b^4*c - 209920*a*b*c^3 - 4096*b^6 + 2304000*b^3*c^2 -
            9427200*c^4,
        -262144*a^6*c^3 + 131072*a^5*b^2*c^2 - 16384*a^4*b^4*c + 2359296*a^4*b*c^3 -
            1114112*a^3*b^3*c^2 - 3538944*a^3*c^4 + 131072*a^2*b^5*c -
            4423680*a^2*b^2*c^3 + 2359296*a*b^4*c^2 + 15925248*a*b*c^4 -
            262144*b^6*c - 3538944*b^3*c^3 - 11943936*c^5
    ];
    I:=ideal<R|

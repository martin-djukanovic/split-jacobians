...
E2:=Curve(A2, -t*(t^2 - 6*t - 3)*(t^4 - 3*t^3 + 9*t + 9)*y^2 + x^3 + ((3*(t^2 + (1 - w^2)*t + 3*w^2))/(t^2 - t*(1 - w) + 3*w))*x^2 + ((3*(t^6 - 2*(2 + w^2)*t^5 - 3*(5 - 2*w^2)*t^4 + 18*t^3*w^2 - 9*(5 + 7*w^2)*t^2 + 18*(2 + w^2)*t + 27*(1 + w^2)))/((t^2 - 6*t - 3)*(t^2 - t*(1 - w) + 3*w)^2))*x + (t^2 + 3*t - 3)/(t^2 - 6*t - 3));
// Note that E2 is a (t^4 - 3*t^3 + 9*t + 9)-twist of the "conjugate" curve, obtained from E1 by replacing w by w^2.
...
f2:=map<C->E2|[
 -1/(t^4 - 3*t^3 + 9*t + 9) * ((t^2 + 3*t*w - 3*w^2)*x + t^2 + 3*t - 3)^2*(4*(t^4 - 3*t^3 + 3*t^2 + 9*t + 9)*x + (t^2 + 3*t - 3)*(t^2 + 3*w^2*t - 3*w))/(4*(t^2 - 6*t - 3)*(t^2 + 3*t - 3)*x^3 + 9*(t^2 + 3*w*t - 3*w^2)^2*x^2 + 6*(t^2 + 3*t - 3)*(t^2 + 3*w*t - 3*w^2)*x + (t^2 + 3*t - 3)^2),
 12*(1 + 2*w)*t/((t^4 - 3*t^3 + 9*t + 9)^2*(t^2 - 6*t - 3)) * y*(3*w*(t^2 + 3*t - 3)*(t^3 - 3*t^2 - 3*t*(4 + 3*w) - 9*w)*(t^3 - (3 + 4*w)*t^2 + 3*w*t + 3*w)*x^2 + x^3*(9*t^8*w - 45*t^7*w + 81*t^6*w - 27*t^5*w - 81*t^3*w - 729*t^2*w + 17*t^7 - 27*t^6 - 99*t^5 + 540*t^4 + 216*t^3 - 972*t^2 - 1215*t*w - 1674*t - 729*w - 729) - 3*t*(t^2 + 3*t - 3)^2*x*(t^2 + 3*t*w + 3*w + 3) - t*(t^2 + 3*t - 3)^3)/(4*(t^2 - 6*t - 3)*(t^2 + 3*t - 3)*x^3 + 9*(t^2 + 3*w*t - 3*w^2)^2*x^2 + 6*(t^2 + 3*t - 3)*(t^2 + 3*w*t - 3*w^2)*x + (t^2 + 3*t - 3)^2)^2
]>;

// an isomorphism between the two elliptic curves
iso:=map<E1->E2|[
  w^2*(t^2 + (w^2-1)*t + 3*w^2)/(t^2 + (w - 1)*t + 3*w)*x - (w+2)*(t-1)*(t+3)/(t^2 + (w - 1)*t + 3*w),
  (t^2 + (w^2-1)*t + 3*w^2)/(t^2 + (w - 1)*t + 3*w)^2*y
]>;

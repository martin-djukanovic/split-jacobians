...
isog2:-map<E1->E2|[
    ((t - 1)*(2*t - 11)*((2*t - 11)^2*(t^2 + 1)^2*(t - 1)^15*x^5 + 20*(t^2 + 1)^2*(t^2 - 10*t + 56)*(t - 1)^12*x^4 + 10*(t^2 + 1)*(4*t^4 - 36*t^3 + 335*t^2 - 60*t + 338)*(t - 1)^9*x^3 + 20*(t^2 + 1)*(2*t^4 - 16*t^3 + 223*t^2 - 50*t + 208)*(t - 1)^6*x^2 + 5*(4*t^6 - 28*t^5 + 565*t^4 - 184*t^3 + 976*t^2 - 176*t + 400)*(t - 1)^3*x + 4*(t^6 - 6*t^5 + 171*t^4 - 62*t^3 + 244*t^2 - 80*t + 1056)))/(5*(t^2 + 1)*(t - 1)^6*x^2 + 10*(t^2 + 1)*(t - 1)^3*x + 5*t^2 + 4)^2, 
    ((t - 1)^3*(2*t - 11)^3*y*((2*t - 11)*(t^2 + 1)^3*(t - 1)^18*x^6 + 6*(2*t - 11)*(t^2 + 1)^3*(t - 1)^15*x^5 + (t^2 + 1)^2*(30*t^3 - 165*t^2 + 8*t - 144)*(t - 1)^12*x^4 + 4*(t^2 + 1)^2*(10*t^3 - 55*t^2 - 12*t - 46)*(t - 1)^9*x^3 + 3*(t^2 + 1)*(10*t^5 - 55*t^4 - 24*t^3 - 116*t^2 - 48*t - 64)*(t - 1)^6*x^2 + 2*(t^2 + 1)*(6*t^5 - 33*t^4 - 32*t^3 - 96*t^2 - 80*t - 80)*(t - 1)^3*x + 2*t^7 - 11*t^6 - 16*t^5 - 60*t^4 - 80*t^3 - 112*t^2 - 64*t - 64))/(5*(t^2 + 1)*(t - 1)^6*x^2 + 10*(t^2 + 1)*(t - 1)^3*x + 5*t^2 + 4)^3
]>;  
...
/*******************************
 ...
 This family will capture some additional cases, such as C: y^2 = x^6 - 1  and  C: y^2 = (x+2)*(x^2 + 3*x + 3) * (x+1)*(x^2 + 3*x + 4)

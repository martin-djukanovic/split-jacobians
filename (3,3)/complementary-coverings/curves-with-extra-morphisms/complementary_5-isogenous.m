...
// the covering maps of degree 3 and 2
L<x,y>:=FunctionField(C);
f1:=map<C->E1|[ -(2*t - 11)*(t^2 + 1)*(x + 1)^2*(2*t + x - 1)/(2*t*x^2 + 4*t*x + 2*t + x^3 - x^2 + 3*x - 11), (2*t - 11)*(t^2 + 1)*y*(8*t*x - 24*t - x^3 + 5*x^2 - 19*x + 7)/(2*t*x^2 + 4*t*x + 2*t + x^3 - x^2 + 3*x - 11)^2, 1]>;
f2:=map<C->E2|[ -(t^2 + 1)*(2*t - 11)*(x - 5)^2*(4*t*x - 2*t + 3*x + 11)/(2*t*x^2 - 4*t*x + 2*t - x^3 - x^2 - 3*x - 11), (t^2 + 1)*(2*t - 11)^3*y*(2*t*x^3 + 2*t*x^2 - 2*t*x - 2*t + x^3 + 9*x^2 + 11*x + 11)/(2*t*x^2 - 4*t*x + 2*t - x^3 - x^2 - 3*x - 11)^2, 1]>;
g1:=map<C->E1|[ -1/4*(2*t - 11)*((2*t - 11)/x^2 + 4*t^2 + 2*t + 3), (2*t - 11)^2*y/(8*x^3), 1]>;
g2:=map<C->E2|[ 1/4*(2*t - 11)*((2*t - 11)*x^2 + 108*t^2 - 38*t + 67), 1/8*(2*t - 11)^3*y, 1]>;

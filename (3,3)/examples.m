...
// Example 3.8 (the only case where j(E)=0 and C-->E has a single ramification point)
K:=Rationals();
R<x>:=PolynomialRing(K);
...
// Example 3.9 (the only case where j(E1)=j(E2) and C-->E2 has a single ramification point, and C-->E1 has two ramification points
QQ:=Rationals();
